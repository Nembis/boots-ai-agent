...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Creates a sub process to run a python script.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="The path to the python script file to execute, relative to the working directory.",
            ),
            "args": types.Schema(
                type=types.Type.ARRAY,
                description="The arguments to pass to the python script. If nothing is passed, no arguments will be used to execute the python scriplt.",
